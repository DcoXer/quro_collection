...
<section class="relative overflow-hidden bg-gray-900" style="min-height: 70vh;">
    ...
    <div class="absolute inset-0">
        <img src="<?php echo e(asset('images/produk2.JPEG')); ?>" alt=""
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div class="reveal text-center md:text-left">
                <p style="font-family: 'Playfair Display', serif;"
                    class="text-3xl md:text-4xl font-semibold text-white mb-1"><?php echo e($stat['value']); ?></p>
                <p class="text-xs text-gray-500 tracking-wide uppercase"><?php echo e($stat['label']); ?></p>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        ...
        <div class="reveal-left relative">
            <div class="aspect-[4/5] rounded-2xl overflow-hidden bg-gray-100">
                <img src="<?php echo e(asset('images/produk1.JPEG')); ?>" alt="Quro Collection"
                    class="w-full h-full object-cover">
            </div>
            
            <div class="absolute -bottom-5 -right-5 bg-gray-900 text-white rounded-2xl px-5 py-4 shadow-xl">
                <p style="font-family: 'Playfair Display', serif;" class="text-xl font-semibold"><?php echo e(now()->year - 2025); ?>+</p>
...
<section class="bg-gray-50 py-20">
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
            <div class="reveal <?php echo e($val['delay']); ?> bg-white rounded-2xl p-8 group hover:shadow-md transition-shadow duration-300">
                <div class="flex items-start justify-between mb-6">
                    <div class="w-12 h-12 bg-gray-900 rounded-xl flex items-center justify-center group-hover:scale-105 transition-transform">
                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="<?php echo e($val['icon']); ?>"/>
                        </svg>
                    </div>
                ...
                <h3 class="font-semibold text-gray-900 mb-2 text-lg"><?php echo e($val['title']); ?></h3>
                <p class="text-sm text-gray-500 leading-relaxed"><?php echo e($val['desc']); ?></p>
            </div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\qurocollection\resources\views/about.blade.php ENDPATH**/ ?>