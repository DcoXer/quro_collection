...
<div class="max-w-4xl mx-auto px-4 py-8 md:py-12">
    ...
    <div class="mb-8">
        ...
        <h1 style="font-family: 'Playfair Display', serif;"
            class="text-3xl font-semibold text-gray-900">Profil</h1>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="md:col-span-1">
            <div class="border border-gray-100 rounded-2xl p-6 text-center sticky top-24">
                ...
                <p class="font-semibold text-gray-900 text-sm"><?php echo e($user->name); ?></p>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="border border-red-50 rounded-2xl p-6">
                ...
                <form id="delete-account-form" method="POST" action="<?php echo e(route('profile.destroy')); ?>" class="hidden">
                    <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\qurocollection\resources\views/profile/edit.blade.php ENDPATH**/ ?>