...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <meta property="og:url" content="<?php echo e(route('shop.index')); ?>">
    <?php $__env->stopPush(); ?>
    ...
    <section class="relative w-full overflow-hidden" style="height: 92vh; min-height: 560px;">
        ...
        <div class="slides-wrapper absolute inset-0">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $slides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isVideo): ?>
                    <div class="slide absolute inset-0 transition-opacity duration-1000 <?php echo e($i === 0 ? 'opacity-100' : 'opacity-0'); ?>">
                ...
                <?php else: ?>
                    <div class="slide absolute inset-0 transition-opacity duration-1000 <?php echo e($i === 0 ? 'opacity-100' : 'opacity-0'); ?>"
                        style="background: url('<?php echo e($fileUrl); ?>') center/cover no-repeat;"></div>
        ...
        <div class="max-w-6xl mx-auto w-full">
            ...
            <div class="flex items-center gap-6">
                <div>
                    <p class="text-white text-xl font-semibold"><?php echo e($categories->count()); ?>+</p>
        ...
        <div class="absolute bottom-6 right-6 md:right-16 z-20 flex items-center gap-3">
            <div class="flex gap-1.5">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $slides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $_): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <button class="dot h-1 rounded-full transition-all <?php echo e($i === 0 ? 'bg-white w-6' : 'bg-white/40 w-2'); ?>"
                        onclick="goToSlide(<?php echo e($i); ?>)"></button>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            </div>
        </div>
    ...
    <section class="max-w-6xl mx-auto px-6 pb-20">
        <div id="product-grid">
            <?php echo $__env->make('shop.partials.product-grid', ['categories' => $categories], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
    </section>
                ...
                <div id="qv-content" class="hidden p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="flex flex-col">
                            ...
                            <?php else: ?>
                            <a id="qv-login-btn" href="<?php echo e(route('login')); ?>"
    ...
    <?php echo app('Illuminate\Foundation\Vite')(['resources/js/pages/shop.js', 'resources/js/pages/quick-view.js']); ?>
    <?php $__env->stopPush(); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\qurocollection\resources\views/shop/index.blade.php ENDPATH**/ ?>