<footer class="mt-24">
    ...
    <div class="relative overflow-hidden bg-gray-900"
        x-data="{
            current: 0,
            total: <?php echo e(count($footerSlides)); ?>,
            timer: null,
            next() {
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $footerSlides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
            <div class="absolute inset-0 transition-opacity duration-700"
                :class="current === <?php echo e($i); ?> ? 'opacity-100 z-10' : 'opacity-0 z-0'">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($slide['type'] === 'image'): ?>
                    <img src="<?php echo e($slide['src']); ?>" class="w-full h-full object-cover" alt="">
                <?php else: ?>
                    <video x-ref="slide_vid_<?php echo e($i); ?>"
        ...
        <div class="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-1.5 z-30">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $footerSlides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                <button @click="current = <?php echo e($i); ?>; handleSlide()"
                    class="h-1 rounded-full transition-all duration-300"
                    :class="current === <?php echo e($i); ?> ? 'bg-white w-5' : 'bg-white/40 w-2'"></button>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        </div>
        ...
        <div class="max-w-6xl mx-auto px-6 pt-14 pb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-10 pb-12 border-b border-gray-800">
                ...
                <div class="md:col-span-5">
                    <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-2.5 mb-5 group w-fit">
                        <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Quro Collection"
                ...
                <div class="md:col-span-3">
                    ...
                    <ul class="space-y-3">
                        <li><a href="<?php echo e(route('home')); ?>" class="text-sm text-gray-400 hover:text-white transition">Beranda</a></li>
                        <li><a href="<?php echo e(route('shop.index')); ?>" class="text-sm text-gray-400 hover:text-white transition">Shop</a></li>
                        <li><a href="<?php echo e(route('about')); ?>" class="text-sm text-gray-400 hover:text-white transition">Tentang Kami</a></li>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                            <li><a href="<?php echo e(route('cart.index')); ?>" class="text-sm text-gray-400 hover:text-white transition">Keranjang</a></li>
                            <li><a href="<?php echo e(route('orders.index')); ?>" class="text-sm text-gray-400 hover:text-white transition">Pesanan Saya</a></li>
                            <li><a href="<?php echo e(route('wishlist.index')); ?>" class="text-sm text-gray-400 hover:text-white transition">Wishlist</a></li>
                        <?php else: ?>
                            <li><a href="<?php echo e(route('login')); ?>" class="text-sm text-gray-400 hover:text-white transition">Masuk</a></li>
                            <li><a href="<?php echo e(route('register')); ?>" class="text-sm text-gray-400 hover:text-white transition">Daftar</a></li>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </ul>
                </div>
            ...
            <div class="pt-6 flex flex-col md:flex-row items-center justify-between gap-5">
                ...
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-gray-800 text-xs text-gray-400">
                            <span class="w-1.5 h-1.5 rounded-full <?php echo e($m['color']); ?>"></span>
                            <?php echo e($m['label']); ?>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <p class="text-xs text-gray-600">
                        © <?php echo e(date('Y')); ?> <span style="font-family: 'Playfair Display', serif;" class="text-gray-500">Quro Collection</span>
                    </p>
                </div>
...
<?php /**PATH C:\laragon\www\qurocollection\resources\views/components/footer.blade.php ENDPATH**/ ?>