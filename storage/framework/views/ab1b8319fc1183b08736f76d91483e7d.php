...
<nav class="border-b border-gray-100 sticky top-0 bg-white/95 backdrop-blur-sm z-50"
    ...
    <div class="max-w-6xl mx-auto px-6 py-3 flex items-center justify-between gap-4">
        ...
        <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-2.5 shrink-0 group">
            <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Quro Collection" class="h-9 w-auto transition group-hover:opacity-80">
        ...
        <div class="hidden md:flex items-center gap-1 text-sm flex-1 justify-center">
            ...
            <a href="<?php echo e(route('shop.index')); ?>"
                ...
                <?php echo e(request()->routeIs('shop.index') || request()->routeIs('shop.show')
            ...
            <div class="relative" x-data="{ catOpen: false }">
                <button @click="catOpen = !catOpen"
                    class="flex items-center gap-1.5 px-4 py-2 rounded-xl transition
                    <?php echo e(request()->routeIs('shop.category') ? 'bg-gray-100 text-gray-900 font-medium' : 'text-gray-500 hover:text-gray-900 hover:bg-gray-50'); ?>">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                ...
                <div x-show="catOpen" x-transition @click.away="catOpen = false"
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <a href="<?php echo e(route('shop.category', $cat)); ?>"
                            ...
                            <?php echo e(request()->routeIs('shop.category') && request()->route('category')?->id === $cat->id
        ...
        <div class="hidden md:flex items-center gap-1 text-sm shrink-0">
            ...
            <a href="<?php echo e(route('cart.index')); ?>"
                class="flex items-center gap-1.5 px-3 py-2 rounded-xl transition relative
                <?php echo e(request()->routeIs('cart.*')
                    ? 'bg-gray-100 text-gray-900 font-medium'
                    : 'text-gray-500 hover:text-gray-900 hover:bg-gray-50'); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
            ...
            <div class="relative ml-1" x-data="{ open: false }">
                <button @click="open = !open"
                    ...
                    <span class="text-sm max-w-[80px] truncate"><?php echo e(auth()->user()->name); ?></span>
                ...
                <div x-show="open" x-transition @click.away="open = false"
                    ...
                    <div class="px-4 py-2 border-b border-gray-50 mb-1">
                        <p class="font-medium text-gray-900 truncate"><?php echo e(auth()->user()->name); ?></p>
...
<?php /**PATH C:\laragon\www\qurocollection\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>