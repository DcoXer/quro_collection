            ...
            <div class="col-span-12 md:col-span-3 space-y-3 pb-4 anim-fade-up delay-4">
                ...
                <div class="bg-gray-950 rounded-2xl p-4">
                    <p style="font-family: 'Playfair Display', serif;"
                        class="text-2xl font-semibold text-white">{{ number_format($totalSold) }}+</p>
    ...
    <div class="max-w-6xl mx-auto px-6 py-16">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
            @foreach([
                ...
                <div class="reveal {{ $stat['delay'] }}">
                    <p style="font-family: 'Playfair Display', serif;"
                        class="text-4xl md:text-5xl font-semibold text-gray-900 mb-1">{{ $stat['number'] }}</p>
...
<section class="border-b border-gray-100">
    <div class="max-w-6xl mx-auto px-6 py-16">
        ...
        <div class="grid grid-cols-2 md:grid-cols-{{ min($categories->count(), 4) }} gap-4">
            @foreach($categories->take(4) as $i => $cat)
            @php $imgs = [asset('images/produk.jpeg'), asset('images/produk1.JPEG'), asset('images/produk2.JPEG'), asset('images/produk3.JPEG')]; @endphp
            <a href="{{ route('shop.category', $cat) }}"
                ...
                <div class="absolute bottom-0 left-0 right-0 p-5">
                    <p class="text-white font-semibold text-base group-hover:translate-y-0 transition">{{ $cat->name }}</p>
    ...
    <div class="max-w-6xl mx-auto px-6 py-20">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
            @foreach([
                ...
                <div class="reveal {{ $value['delay'] }} group border border-gray-100 rounded-2xl p-7 hover:border-gray-900 hover:shadow-sm transition-all duration-300">
                    ...
                    <h3 class="text-base font-semibold text-gray-900 mb-2">{{ $value['title'] }}</h3>
    ...
    <div class="relative z-10 max-w-6xl mx-auto px-6 py-24 flex flex-col md:flex-row items-center justify-between gap-10 reveal">
        <div>
            ...
            <p class="text-gray-400 text-sm max-w-sm">
                Lebih dari {{ $totalProducts }} produk siap menemani penampilan elegan kamu sehari-hari.
            </p>
        </div>
